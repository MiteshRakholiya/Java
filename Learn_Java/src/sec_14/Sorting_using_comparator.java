...
public class Sorting_using_comparator {
	...
	public static void main(String[] args) {
		...
		set.add(new Data<Integer, String>(1, "Mitesh"));
		set.add(new Data<Integer, String>(5, "Meraj"));
		set.add(new Data<Integer, String>(9, "Rahul K"));
		set.add(new Data<Integer, String>(2, "Prashant"));
		set.add(new Data<Integer, String>(1, "Mehull"));
		set.add(new Data<Integer, String>(1, "Bhavik"));
